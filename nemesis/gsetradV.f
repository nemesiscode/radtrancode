...
51       read(9,1)buffer
         ...
         if(ncont1.ne.ncont)then
          print*,'Error in gsetradV ncont1 <> ncont'
          print*,ncont1,ncont
          print*,'file : ',runname
         endif
...
54       read(9,1)buffer
         ...
         if(nalb1.ne.nalb)then
          print*,'Error in gsetradV nalbx <> nalb1'
          print*,nalb,nalb1
          print*,'file : ',runname
         endif
...
C       ***************** Surface temperature correction ***********
      ...
      do ivar=1,nvar
       ...
       print*,'gsetradV - ',ivar,varident(ivar,1)
...
55      read(9,1)buffer
        ...
        read(buffer,*)nalb1
        if(nalb1.ne.nalb)then
         print*,'Error in gsetradV nalb <> nalb1'
         print*,nalb,nalb1
         print*,'file : ',runname
        endif
