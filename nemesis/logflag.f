...
C       Variable is not temperature  - may need to take exponent
        ...
        if(imod.eq.48.and.ip.eq.1)iflag=1 ! variable knee profile
      ...
      if(imod.eq.48.and.ip.eq.2)iflag=1 ! variable knee profile
      if(imod.eq.48.and.ip.eq.3)iflag=1 ! variable knee profile
      if(imod.eq.48.and.ip.eq.4)iflag=1 ! variable knee profile
      ...
      if((imod.ge.12.and.imod.le.13).or.imod.eq.47.or.imod.eq.50.
     & or.imod.eq.58)then 
      ...
      if(imod.eq.63)iflag=1	! Log scaling factor
      if(imod.eq.64)iflag=1	! Log scaling factor
      if(imod.eq.65)iflag=1	! Log scaling factor
      if(imod.eq.66)iflag=1	! Log scaling factor
