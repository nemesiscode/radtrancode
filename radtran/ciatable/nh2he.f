      SUBROUTINE NH2HE(FPARA,TEMP,FREQ,ALFATOT)
C     *************************************************************
...
C
      ...
      IF(TEMP.LT.40.OR.TEMP.GT.3000)THEN
       PRINT*,'nh2he: Temperature should be 40 < T < 3000',TEMP  
      END IF
...
C     (QUADRUPOLE PLUS OVERLAP INDUCED COMPONENT)
      ...
      IFUN  = 1
      CALL ADDSPEC3(FREQ,ABSCOEF,XM0,T1,T2,TEMP,0,0,-1,-1,2,3,0,0,IFUN)
...
C     PARAMETERS FOR 21 (PURE OVERLAP) COMPONENT
      ...
      IFUN = 0
      CALL ADDSPEC3(FREQ,ABSCOEF,XM0,T1,T2,TEMP,0,0,-1,-1,2,1,0,0,IFUN)
      ALFATOT=ALFATOT+ABSCOEF
C
C     PARAMETERS FOR 01 (PURE OVERLAP) COMPONENT
      ...
      CALL K0PARAM(TEMP, XM0, XM1, XM2, T1, T2)
      IFUN = 0
      CALL ADDSPEC3(FREQ,ABSCOEF,XM0,T1,T2,TEMP,0,0,-1,-1,0,1,0,0,IFUN)
      ALFATOT=ALFATOT+ABSCOEF
      ...
      SUBROUTINE ADDSPEC3 (FREQ,ABSCOEF,G0,TAU1,TAU2,TEMP,MP,LIKE,
     1 LAMBDA1,LAMBDA2,LAMBDA,LVALUE,NVIB1,NVIB2,IFUN)
C
...
C
   ...
   20 Z=DFLOAT(N+1)
      ...
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     G0,G1,G2 are three lowest translational moments	
