...
C***********************************************************************
      ...
      PARAMETER (MAXDGAS=100,MAXISO=10)

      INTEGER DBRECL,DBSIZ,DBFORM,LOCID(MAXDGAS)
      INTEGER DBISO(MAXISO,MAXDGAS),DBNISO(MAXDGAS),DBREC,DBLUN,INDRL
      COMMON /DBINT/ DBRECL,DBSIZ,DBFORM,LOCID,DBISO,DBNISO,
     1 DBREC,DBLUN,INDRL
      ...
      CHARACTER*1 LNFLAG
      CHARACTER*100 IPFILE,DBFILE,KEYFIL,INDFIL,ISOFIL,GASFIL,XSCFIL
      CHARACTER*100 DGFILE,RADFILE
     ...
     1 GASNAM,DBNAME,DGFILE,RADFILE
      ...
      INTEGER LNACC04(6),LNREF04(6)
      COMMON /LNINT/ LNID,LNISO,LNUGQI,LNLGQI,LNACC,LNREF,
     1  LNACC04,LNREF04

      DOUBLE PRECISION LNSTR,LNPROB,LNEINA
      REAL LNWAVE,LNWIDA,LNWIDS,LNLSE,LNTDEP,LNTDEPS
      REAL LNPSH,LDOUBV,UWGHT,LWGHT

      COMMON /LNREAL/LNWAVE,LNSTR,LNPROB,LNWIDA,LNWIDS,LNLSE,LNTDEP,
     1LNTDEPS,LNPSH,LDOUBV,LNEINA,UWGHT,LWGHT
     ...
     1 LNUGQI04,LNLGQI04,LNULQ04,LNLLQ04,LNFLAG
C--------------------------------------------------------------
