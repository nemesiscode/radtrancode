...
C UPFLUX: =.TRUE. if doing internal upwards flux calculation
C OUTFLUX: =.TRUE. if doing upwards flux calculation at top of atmosphere
C BOTFLUX: =.TRUE. if doing downards flux calculation at bottom of atmosphere
