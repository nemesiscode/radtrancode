C     $Id: lincoms.f,v 1.1 2011-06-17 14:48:20 irwin Exp $
C***********************************************************************
C_TITL: LINCOM
C
C_DESC:
...
C IDLIN: Air Force Geospace Lab. identifier.
      ...
      REAL VLIN(MAXLIN),SLIN(MAXLIN),ALIN(MAXLIN),PSHIFT(MAXLIN)
...
C LLQ: lower state local quanta. (15 elements for Hitran04, 9 otherwise)
      ...
      COMMON /LINCOMS/ VLIN,SLIN,ALIN,ELIN,SBLIN,PSHIFT,DOUBV,TDW,TDWS,
