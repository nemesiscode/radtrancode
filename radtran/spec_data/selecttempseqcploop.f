...
C BINSIZ: Size [cm-1] of bins for limit selection.
      ...
      REAL TEMP,TS1,TS2,PARTF,TEMP1(20),TMIN,TMAX
...
21    FORMAT(A)
      ...
      CALL PROMPT('Enter starting ITEMP : ')
      READ*,JTEMP
      DO 1001 ITEMP=JTEMP,NTEMP
       TEMP=TEMP1(ITEMP)
       print*,ITEMP,TEMP
       I1=INT(ITEMP/10)
       I2=ITEMP-10*I1
       ...
       WRITE(BUFFER,114)
114    FORMAT(' # data records written by routine SELECTTEMPSEQCPLOOP')
